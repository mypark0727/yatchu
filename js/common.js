...
$(document).ready(function(){
	...
	// 팝업
	let btnPopOpen = document.querySelector('.btn.open');
	let btnPopClose = document.querySelector('.btn.close');
	let popDom = document.querySelector('.popupWrap');

	btnPopOpen.addEventListener('click',function () {
		popDom.classList.add('active');
	})

	btnPopClose.addEventListener('click',function () {
		popDom.classList.remove('active');
	})
